...
//插入参数
VOID CDataBaseAide::AddParameterOutput(LPCTSTR pszItem, LPSTR pszString, UINT uSize, ADOCG::ParameterDirectionEnum ParameterDirection)
{
	ASSERT(m_pIDataBase!=NULL);
...
//插入参数
VOID CDataBaseAide::AddParameterOutput(LPCTSTR pszItem, LPWSTR pszString, UINT uSize, ADOCG::ParameterDirectionEnum ParameterDirection)
{
	ASSERT(m_pIDataBase!=NULL);
	m_pIDataBase->AddParameter(pszItem,adVarChar,ParameterDirection,uSize,CDBVarValue(pszString));
	return;
