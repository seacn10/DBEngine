...
//{
//public:
//	CDataBaseHelper() : CTempldateHelper<IDataBase>(IID_IDataBase, VER_IDataBase){ }
//};
...
//{
//public:
//	CDataBaseHelper() : CTempldateHelper<IDataBase>(IID_IDataBase, VER_IDataBase, "KernelEngine.dll", "CreateDataBase"){}
//};
